        ...
        public static IEnumerable<Movie> GetMovies()
        {
            return new List<Movie>
            {
                new()
                {
                    ...
                    {
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 13, 14, 20, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 13, 17, 10, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 13, 20, 30, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 14, 14, 20, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 14, 17, 10, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 14, 20, 30, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 15, 14, 20, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 15, 17, 10, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 15, 21, 40, 0))
                    }
                },
                new()
                {
                    ...
                    Events = new List<Event>()
                    {
                        new(new Hall("Sál 02"), 160, new DateTime(2023, 3, 13, 15, 10, 0)),
                        new(new Hall("Sál 02"), 160, new DateTime(2023, 3, 14, 15, 10, 0)),
                        new(new Hall("Sál 02"), 160, new DateTime(2023, 3, 15, 15, 10, 0)),
                    }
                ...
                new()
                {
                    ...
                    Events = new List<Event>()
                    {
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 16, 15, 0, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 17, 15, 0, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 18, 17, 0, 0)),
                        new(new Hall("Sál 01"), 180, new DateTime(2023, 3, 19, 20, 0, 0)),
                    }
                },
                ...
                new()
                {
                    ...
                    Events = new List<Event>()
                    {
                        new(new Hall("Sál 02"), 180, new DateTime(2023, 3, 16, 18, 0, 0)),
                        new(new Hall("Sál 02"), 180, new DateTime(2023, 3, 17, 18, 0, 0)),
                        new(new Hall("Sál 02"), 180, new DateTime(2023, 3, 18, 20, 0, 0)),
                        new(new Hall("Sál 02"), 180, new DateTime(2023, 3, 19, 18, 0, 0)),
                        new(new Hall("Sál 02"), 180, new DateTime(2023, 3, 20, 16, 0, 0)),
                    }
                }
            };
        }
