        ...
        public static IEnumerable<Movie> GetMovies()
        {
            return new List<Movie>()
            {
                ...
                new()
                {
                    ...
                    Events = new List<Event>
                    {
                        new() { DateTime = new DateTime(2023, 3, 16, 15, 0, 0), Price = 180 },
                        new() { DateTime = new DateTime(2023, 3, 17, 15, 0, 0), Price = 180 },
                        new() { DateTime = new DateTime(2023, 3, 18, 17, 0, 0), Price = 180 },
                        new() { DateTime = new DateTime(2023, 3, 19, 20, 0, 0), Price = 180 },
                    }
                },
                ...
                new()
                {
                    ...
                    Events = new List<Event>
                    {
                        new() { DateTime = new DateTime(2023, 3, 16, 18, 0, 0), Price = 180 },
                        new() { DateTime = new DateTime(2023, 3, 17, 18, 0, 0), Price = 180 },
                        new() { DateTime = new DateTime(2023, 3, 18, 20, 0, 0), Price = 180 },
                        new() { DateTime = new DateTime(2023, 3, 19, 18, 0, 0), Price = 180 },
                        new() { DateTime = new DateTime(2023, 3, 20, 16, 0, 0), Price = 180 },
                    }
                }
